...
int main(int argc, char **argv)
{
    ...
    model->train(train_X, train_Y, 0.03f, n_train, 50);
    ...
    result *res;
    res = model->evaluate(test_X, test_Y, n_test);
    //std::cout << res->predictions << std::endl;
